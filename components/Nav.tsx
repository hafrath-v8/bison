...
export default function Nav() {
  ...
  const desktopProductRef = useRef<HTMLDivElement | null>(null);

  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        desktopProductRef.current &&
        !desktopProductRef.current.contains(event.target as Node)
      ) {
  ...
  return (
    <header className="bg-gradient-to-r from-black via-emerald-900 to-black" id="home">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-2">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <a
            href="#home"
            className="text-sm/6 font-semibold text-[#eccece] hover:text-emerald-300 transition-colors duration-300 relative group"
          >
            Home
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#contact"
            className="text-sm/6 font-semibold text-[#eccece] hover:text-emerald-300 transition-colors duration-300 group px-4 py-2 rounded-lg bg-gradient-to-r from-yellow-500/10 to-emerald-500/10 hover:from-yellow-500/20 hover:to-emerald-500/20 border border-yellow-500/30"
          >
            Contact
          </a>
        </div>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-yellow-500/20">
                <div className="space-y-2 py-6">
                  <a
                    href="#home"
                    className="-mx-3 block rounded-lg px-3 py-3 text-base/7 font-semibold text-[#eccece] hover:bg-gradient-to-r hover:from-yellow-500/20 hover:to-emerald-500/20 hover:border-l-4 hover:border-yellow-400 transition-all duration-300 border-l-4 border-transparent"
                  >
                    Home
                  </a>
                  <a
                    href="#product"
                    className="-mx-3 block rounded-lg px-3 py-3 text-base/7 font-semibold text-[#eccece] hover:bg-gradient-to-r hover:from-emerald-500/20 hover:to-yellow-500/20 hover:border-l-4 hover:border-emerald-400 transition-all duration-300 border-l-4 border-transparent"
                  >
                    Products
                  </a>
                  <a
                    href="#testimonials"
                    className="-mx-3 block rounded-lg px-3 py-3 text-base/7 font-semibold text-[#eccece] hover:bg-gradient-to-r hover:from-yellow-600/20 hover:to-emerald-600/20 hover:border-l-4 hover:border-yellow-500 transition-all duration-300 border-l-4 border-transparent"
                  >
                    Testimonial
                  </a>
                  <a
                    href="#about"
                    className="-mx-3 block rounded-lg px-3 py-3 text-base/7 font-semibold text-[#eccece] hover:bg-gradient-to-r hover:from-emerald-600/20 hover:to-yellow-600/20 hover:border-l-4 hover:border-emerald-500 transition-all duration-300 border-l-4 border-transparent"
                  >
                    About
                  </a>
                </div>
                <div className="py-6">
                  <a
                    href="#contact"
                    className="-mx-3 block rounded-lg px-3 py-3 text-base/7 font-semibold text-[#eccece] hover:bg-gradient-to-r hover:from-yellow-500/20 hover:to-emerald-500/20 transition-all duration-300 group border border-yellow-500/30"
                  >
                    <span className="flex items-center justify-between">
                      Contact
                      <span className="group-hover:translate-x-2 transition-transform duration-300 text-emerald-300">
                        →
                      </span>
                    </span>
                  </a>
